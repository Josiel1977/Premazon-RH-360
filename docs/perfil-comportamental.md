...
Depois, abra **Gestão de Pessoas > Saúde do Sistema** e confirme as três verificações da migração 011. A aplicação reutiliza `SUPABASE_SECRET_KEY`; não existe variável de ambiente adicional.
